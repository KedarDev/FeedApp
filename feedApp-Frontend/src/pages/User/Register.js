...
const Register = () => {
  ...
  // empty array as the second argument to useEffect means that this effect will only run once, when the component is first mounted
  useEffect(() => {
    document.title = "Register | Feed App";
  }, []);

  // when the form is submitted, all the registerApi fxn
  ...
  // validation to the fields [N] Yup uses the name of the input to match the validation
